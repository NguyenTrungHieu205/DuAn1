...
public class RamRepository {
    ...
    public ArrayList<RamViewModel> getAll() throws SQLException {
        ...
        String sql = "SELECT MaRam, TenRAM, TrangThai FROM ram";
    ...
    public boolean create(RamViewModel dl) throws SQLException {
     ...
     public ArrayList<RamViewModel> getAllXoa() throws SQLException {
        ...
        String sql = "SELECT MaRam, TenRAM FROM ram WHERE TrangThai = '4' ";
        Connection conn = DBContext.getConnection();
        PreparedStatement stm = conn.prepareStatement(sql);
        ResultSet rs = stm.executeQuery();
        while (rs.next()) {
     ...
     public boolean updateTT(RamViewModel dl) throws SQLException {
        String sql = "UPDATE ram SET TrangThai = '4' WHERE MaRam =? ";
        try ( Connection conn = DBContext.getConnection();  PreparedStatement stm = conn.prepareStatement(sql);) {
