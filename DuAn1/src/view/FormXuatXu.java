...
public class FormXuatXu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblXuatXu.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã xuất xứ", "Nơi xuất xứ", "Trang thái"
            }
        ));
    ...
    private void tblXuatXuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblXuatXuMouseClicked
        ...
        if(tblXuatXu.getValueAt(row, 2).toString().equals("Online")){
            rdOnline.setSelected(true);
        }else if(tblXuatXu.getValueAt(row, 2).toString().equals("Offline")){
            rdOffline.setSelected(true);
        }else if(tblXuatXu.getValueAt(row, 2).toString().equals("Đang chờ hàng về")){
