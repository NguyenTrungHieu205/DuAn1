...
public class FormRam extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblRam.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã ram", "Dung lượng ram", "Trạng thái"
            }
        ));
        ...
        jPanel2.add(txtMaRam, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 50, 202, -1));

        lblRam.setText("GB");
        jPanel2.add(lblRam, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 100, 37, 30));
        jPanel2.add(txtTenRam, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 100, 202, -1));
        ...
        jPanel2.add(rdOffline, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 160, -1, -1));
    ...
    private void tblRamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRamMouseClicked
        ...
        txtTenRam.setText(stringBuilder.toString());
         if(tblRam.getValueAt(row, 2).toString().equals("Online")){
            rdOnline.setSelected(true);
        }else if(tblRam.getValueAt(row, 2).toString().equals("Offline")){
            rdOffline.setSelected(true);
        }else if(tblRam.getValueAt(row, 2).toString().equals("Đang chờ hàng về")){
